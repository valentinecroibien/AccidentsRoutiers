...
#setwd("~/Documents/Université/Master SEP/M2/S1/SEP0953 - Conf, Business/Cousin/AccidentsRoutiers")
...
```{r}
### En attente du modèle AIC sur un échantillon réduit de 10000 pris au hasard parmi les 130857 observations
...
#set.seed(1654) si on veut refaire base de test et train
...
modele.backward <- step(object = modele.redcomp, 
                       ...
                       direction = "backward",steps=20)
modele.backward 

# en forward Idem mais plus long.... 
...
# on se rend compte qu'en enlevant les heures et min ça ne change pas grand chose mais 
# ça allège le calcul
